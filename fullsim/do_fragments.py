...
for proc in procs :
    for mass in masses :
        ...
        newFile = "submit_"+nameprc+"_premix_ste1.py"
        writeSubmit ="\
...
config.JobType.psetName = '%s_1_cfg.py'\n\
...
config.section_('JobType')\n\
config.JobType.pluginName = 'Analysis'\n\
config.JobType.psetName = '%s_premix_cfg.py'\n\
config.JobType.maxMemoryMB = 2600\n\
config.JobType.numCores = 8\n\
\n\
config.section_('Data')\n\
...
config.section_('JobType')\n\
config.JobType.pluginName = 'Analysis'\n\
config.JobType.psetName = '%s_miniaod_cfg.py'\n\
config.JobType.maxMemoryMB = 2600\n\
config.JobType.numCores = 8\n\
\n\
config.section_('Data')\n\
...
" % (nameprc, nameprc)
        ...
        file.write(writeSubmit)
        file.close()
        procsToSubMiniAod.write(newFile+"\n")
